    ...
    def scrape_data(self):
        ...
        try:
            ...
            for desired_car in self.desired_car:
                ...
                items = soup.find_all("a", {"tabindex": True})
                test = soup.find_all(
                ...
                for item in items:
                    ...
                    if match and img_element:
                        ...
                        try:
                            ...
                            car_element = item.select_one(
                                "div > div > span > div > span > span"
                            ).text.strip()
                            if "$" in car_element:
                                compare_price_element = car_element
                                car_element = current_desired_car
                            location_element = "searching broke it"
                            if not self.desired_car:
                                location_element = test[loc_index].text.strip()
                            mileage_element = item.select_one(
